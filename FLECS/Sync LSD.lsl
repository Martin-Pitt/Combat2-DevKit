...
string protectedKey = "-----REPLACE WITH PROTECTED KEY VALUE-----";

/// Scope prefixes of linkset data keys to synchronise
list scopes = [
    "FLECS_Agents",
    "C2_Teams_Config",
    "C2_Teams.", // C2_Teams.<team_no>
    "C2_Teams:", // C2_Teams:<uuid>
    "C2_Respawns.", // C2_Respawns.<team_no>
    "C2_Respawns:" // C2_Respawns:<uuid>
];
