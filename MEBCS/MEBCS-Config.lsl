default
{
    state_entry()
    {
        ...
        llLinksetDataWrite("MEBCS_TeamsConfig", llList2Json(JSON_ARRAY, [
        ...
        llLinksetDataWrite("MEBCS_Teams.0", llList2Json(JSON_ARRAY, []));
        llLinksetDataWrite("MEBCS_Teams.1", llList2Json(JSON_ARRAY, []));
        llLinksetDataWrite("MEBCS_Teams.2", llList2Json(JSON_ARRAY, []));
        
        // Clearing out team assignments for agents/objects
        llLinksetDataDeleteFound("^MEBCS_Teams:", "");
    }
}
