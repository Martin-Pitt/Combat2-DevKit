...
// C2_Respawns.<team_no>
// C2_Respawns:<uuid>
// C2_Respawns_Preferred:<uuid>
// MEBCS_Combatant.Activity:<uuid>
// MEBCS_Combatant.Status:<uuid>
// MEBCS_Combatant.Downed:<uuid>
// MEBCS_Teams_Active.<team_no>
// MEBCS_Teams_Downed.<team_no>
